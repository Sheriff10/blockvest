   ...
   return (
      <div className="bg-gray-900 text-gray-300">
         ...
         <div className="relative isolate px-6 pt-14 lg:px-8">
            ...
            >
               <div
                  className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#000] to-[#83dcff] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
                  style={{
                     clipPath:
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
               ...
               <div className="text-center">
                  ...
                  <p className="mt-6 text-lg leading-8 text-gray-500">
                     Embarking on a Journey of Empowerment, Guiding Futures
                     through Thoughtful Investments and Unleashing Opportunities
                     for Lasting Success.
                  </p>
